...
<body>
    ...
    Nama :
    <input type="text" name="nama" value=   "<?=$dt_pelanggan
    ['nama']?>" class="form-control">

        Alamat :

    <input type="text" name="alamat" value="<?=$dt_pelanggan
     ['alamat']?>" class="form-control">

Telp :
            <input type="text" name="telp" value="<?=$dt_pelanggan
     ['telp']?>" class="form-control">

Username :
            <input type="text" name="username" value="<?=$dt_pelanggan
     ['username']?>" class="form-control">
Foto Pelanggan :
            <input type="file" name="foto_pelanggan" value="<?=$dt_pelanggan
     ['foto_pelanggan']?>" class="form-control">
