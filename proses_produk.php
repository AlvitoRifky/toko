...
if($_POST){
    ...
    if(empty($_POST['produk'])){
        ...
        if (move_uploaded_file($_FILES["foto_produk"]["tmp_name"], $target_file)) {
            ...
            $insert=mysqli_query($conn,"insert into produk (nama_produk, deskripsi, harga, foto_produk) value ('".$_POST['produk']."','".$_POST['deskripsi']."','".$_POST['harga']."','".basename($_FILES["foto_produk"]["name"])."')");
            if($insert == !false){
